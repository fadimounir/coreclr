...
enum CorInfoHelpFunc
{
    ...
    CORINFO_HELP_RUNTIMEHANDLE_METHOD_WITHSLOT, // determine a type/field/method handle at run-time, with dictionary slot
    ...
    CORINFO_HELP_RUNTIMEHANDLE_CLASS_WITHSLOT,  // determine a type/field/method handle at run-time, with dictionary slot
