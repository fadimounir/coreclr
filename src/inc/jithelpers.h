...
// It will be set in InitJITHelpers2
    ...
    JITHELPER(CORINFO_HELP_RUNTIMEHANDLE_METHOD_WITHSLOT,   JIT_GenericHandleMethodWithSlot,    CORINFO_HELP_SIG_REG_ONLY)
    ...
    JITHELPER(CORINFO_HELP_RUNTIMEHANDLE_CLASS_WITHSLOT,    JIT_GenericHandleClassWithSlot,     CORINFO_HELP_SIG_REG_ONLY)
