        ...
        RetryMatch:
            ...
            if (pCandidate != NULL)
            {
                ...
                if (pSigBuilder != NULL)
                {
                    ...
                    if (ExecutionManager::FindReadyToRunModule(dac_cast<TADDR>(pCandidate)) == NULL)
                    {
                            ...
                            int                      nFirstOffset)
{
    ...
    WORD slotDummy;
    return FindTokenWorker(pAllocator, numGenericArgs, pDictLayout, pResult, pSigBuilder, pSig, cbSig, nFirstOffset, &slotDummy);
}
...
DictionaryLayout::FindToken(LoaderAllocator *        pAllocator,
                            ...
                            WORD *                   pSlotOut)
{
    return FindTokenWorker(pAllocator, numGenericArgs, pDictLayout, pResult, NULL, signature, -1, nFirstOffset, pSlotOut);
}
    ...
    DWORD              dictionaryIndexAndSlot /* = -1 */)
{
    ...
    *ppSlot = NULL;
    ...
    Module * pReadyToRunModule = ExecutionManager::FindReadyToRunModule(dac_cast<TADDR>(signature));

    ZapSig::Context zapSigContext(MscorlibBinder::GetModule(), (void *)pContainingZapModule, ZapSig::NormalTokens);
    ...
    if (pReadyToRunModule != NULL)
    {
        ...
        zapSigContext = ZapSig::Context(pInfoModule, pReadyToRunModule, ZapSig::NormalTokens);
    ...
    Module * pLookupModule = (pReadyToRunModule != NULL) ? pZapSigContext->pInfoModule : MscorlibBinder::GetModule();
...

    {
        ...
        case MethodEntrySlot:
        {
            ...
            if (kind == ConstrainedMethodEntrySlot)
            {
                ...
                _ASSERT(pReadyToRunModule == NULL);
